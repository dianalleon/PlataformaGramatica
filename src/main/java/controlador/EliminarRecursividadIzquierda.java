 ...
 * @author User
 */
public class EliminarRecursividadIzquierda extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("EliminarRecursividadIzquierda.do");
        ...
        String alert = null;
        while (normalizacion.existeRecursividadIzquierda(gramatica)) {
            normalizacion.eliminarRecursividadIzquierda(gramatica);
        }
        cont++;
