 ...
 * @author User
 */
@WebServlet(name = "EliminarVariablesUnitarias", urlPatterns = {"/EliminarVariablesUnitarias.do"})
public class EliminarVariablesUnitarias extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("EliminarVariablesUnitarias.do");
